            ...
            <div className='bg-[#1a1a1a] rounded-lg p-6 min-h-[600px]'>
              ...
              <div className='bg-[#2a2a2a] rounded-lg p-4'>
                <div className='text-center text-gray-300 py-20'>
                  ...
                  <h3 className='text-xl font-medium mb-2'>Day Planner Coming Soon</h3>
                  <p className='text-gray-400'>
                    We're building a comprehensive daily planning system to help you organize your lifestyle activities.
                  </p>
                </div>
              </div>
            </div>
