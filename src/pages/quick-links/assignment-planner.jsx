        ...
        <main className='flex w-full min-h-screen select-none'>
          ...
          >
            ...
            <div className='bg-[#1a1a1a] rounded-lg p-6 min-h-[600px]'>
              ...
              {/* Assignment Planner Grid */}
              <div className='bg-[#2a2a2a] rounded-lg p-4'>
                <div className='text-center text-gray-300 py-20'>
                  <div className='text-6xl mb-4'>📝</div>
                  <h3 className='text-xl font-medium mb-2'>Assignment Planner Coming Soon</h3>
                  <p className='text-gray-400'>
                    We're building a comprehensive assignment planning system to help you manage your coursework.
                  </p>
                </div>
              </div>
            </div>
