...
function LifestyleBucketListPage() {
  return (
    <div>
      <div>
        <Navbar />
        ...
        <HeaderContent title="Bucket List" />
        <NavigationLinks />
        <WavyLines />
            ...
            <div className='bg-[#1a1a1a] rounded-lg p-6 min-h-[600px]'>
              ...
              <div className='bg-[#2a2a2a] rounded-lg p-4'>
                <div className='text-center text-gray-300 py-20'>
                  ...
                  <h3 className='text-xl font-medium mb-2'>Bucket List Coming Soon</h3>
                  <p className='text-gray-400'>
                    We're building a comprehensive bucket list system to help you track and achieve your life goals and dreams.
                  </p>
                </div>
              </div>
            </div>
...
export default LifestyleBucketListPage